...
import com.rahadyan.rms.security.CustomUserDetailsService;
import com.rahadyan.rms.security.JwtAuthenticationEntryPoint;
import com.rahadyan.rms.security.JwtAuthenticationFilter;
        ...
        http
                ...
                .authorizeRequests()
                    .antMatchers("/",
                        ...
                        "/**/*.js")
                        .permitAll()
                    .antMatchers("/api/v1/auth/**", "/v2/api-docs", "/configuration/**", "/swagger*/**", "/webjars/**")
                        .permitAll()
                    .anyRequest()
                    	.permitAll();
